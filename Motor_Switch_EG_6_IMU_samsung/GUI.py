...
class MainWindow(QWidget):
    ...
    def _build_layout(self):
        ...
        self.sb_gate_k             = make_dspin(15.00, 0, 100, 1.0, 2, "Feedback Gain k (0..10)")
...
# 新增：max_torque_cfg 旋钮（2.0~15.0 Nm）
        ...
        self.sb_Assist_delay_gain   = make_dspin(0.2, 0, 1.00, 0.001, 3, "ext_phase_frac_L (0..0.5)")
        ...
        # === 摆放到网格（按你喜好排）===
        labels = [
            "Feedback Gain k", "Delay_gain"
        ]
        spins = [

            self.sb_gate_k, self.sb_Assist_delay_gain
        ]
    ...
    def _tx_params(self):
        ...
        gate_k            = max(0.0,  min(50.0, gate_k))
